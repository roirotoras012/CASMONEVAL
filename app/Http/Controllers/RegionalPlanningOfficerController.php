...
class RegionalPlanningOfficerController extends Controller
{
    ...
    public function add_targets(Request $request){
        ...
        return redirect()->route('rpo.show', $opcr->id)->with('success','Targets Added Successfully.');
        // return $request->data;
    }
    ...
    public function update_targets(Request $request){
        ...
        if($request->submit == 'update'){
            ...
            return redirect()->route('rpo.show', $opcr_id)->with('success','Targets Updated Successfully.');
        ...
        elseif($request->submit == 'submit'){
            ...
            return redirect()->route('rpo.show', $opcr_id)->with('success','Targets Submitted Successfully.');
        }
