...
class RegionalPlanningOfficerController extends Controller
{
    ...
    public function add_targets(Request $request)
    {
        ...
        return redirect()->route('rpo.show', $opcr->opcr_ID);
        // return $request->data;
    }
    ...
    public function update_targets(Request $request)
    {
        ...
        if ($request->submit == 'update') {
            ...
            return redirect()->route('rpo.show', $opcr_id);
            ...
            return redirect()->route('rpo.show', $opcr_id);
        } elseif ($request->submit == 'update_target') {
            // dd($request);
    ...
    public function cutOff(Request $request)
    {
        ...
        DB::transaction(function () use ($request, &$action) {
            ...
            if ($request->submit == 'cutoff') {
                ...
                $newStatus = substr_replace($cutoff_status, '0', array_search($month, $monthsArray), 1);
                $action = 'reopen';
            } else {
    ...
    public function recover_opcr(Request $request)
    {
        ...
        if ($opcr && $opcr->is_active !== 1) {
            ...
            return redirect()->route('rpo.archive');
        }
    }
