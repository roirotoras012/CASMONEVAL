                                ...
                                <tbody>
                                    ...
                                    <div class="pb-3 opcr-btn">
                                        ...
                                        <a href="#" data-bs-toggle="modal"
                                            ...
                                            class="text-decoration-none text-black btn btn-primary text-white"><i class="fas fa-upload"></i> Mark as Done
                                        ...
                                        <button type="button" class="btn btn-primary my-2"
                                            data-file-name="opcr-{{ $opcr_id }}_{{ $opcr[0]->year }}"
                                            data-file-type="Regional"
                                            id="print-scoreCard"><i class="fas fa-download"></i> Scorecard</button>
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#cutoff-{{ $opcr_id }}"
                                            id="#cutoff-{{ $opcr_id }}"
                                            class="text-decoration-none text-black btn btn-primary text-white"><i class="fas fa-cut"></i> Cutoff or
                                            Reopen
