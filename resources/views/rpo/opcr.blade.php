    ...
    <x-user-sidebar>
        ...
        <div class="container-fluid px-4 py-5">
                                    ...
                                    @foreach ($labels as $label)
                                        <tr class="table-tr">
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    <input type="hidden" name="data[{{ $ctr }}][CAM]"
                                                        value="">
            ...
            <div class="pb-3 opcr-btn">
                <button <?php if ($opcr[0]->is_submitted == true){ ?> disabled <?php   } ?> type="submit" name="submit"
                ...
                <button <?php if ($opcr[0]->status == 'INCOMPLETE' || $opcr[0]->is_submitted == true){ ?> disabled <?php   } ?> type="submit" value="submit" name="submit"
                ...
                <button style="display: none" type="button" class="btn btn-primary my-2"
                    data-file-name="opcr-{{ $opcr_id }}_{{ $opcr[0]->year }}" id="print-button">Scorecard</button>
