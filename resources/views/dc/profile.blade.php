                ...
                <div class="p-5 bg-white rounded shadow mb-5">
                    ...
                    <div id="myTab1Content" class="tab-content">
                        <div id="home1" role="tabpanel" aria-labelledby="home-tab"
                            ...
                            <form method="POST" action="{{ route('dc.updateProfileHandler') }}">
                                <div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input value={{ $userDetails->first_name }} id="first_name" type="text"
                                                class="form-control form-update" name="first_name" autofocus pattern="^[a-zA-Z\s]*$" required>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input value={{ $userDetails->middle_name }} placeholder="Middlename"
                                                id="middle_name" type="text" class="form-control form-update" name="middle_name" pattern="^[a-zA-Z\s]*$" required
                                    ...
                                    <button type="submit" class="btn btn-primary" id="profile-update">Update Profile</button>
                        ...
                        <div id="profile1" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-4 py-5">
                            <form method="POST" action="{{ route('dc.updateEmailHandler') }}">
                                @csrf
                                <div class="form-group">
                                    <label>Email</label>
